...
<head>
    ...
    <meta name="description" content="DONER KEBAB 21 - Scopri il nostro menù con sapori autentici e ingredienti di qualità.">
    <title>Menù - DONER KEBAB 21</title>
...
<body>
    ...
    <section class="hero">
        <div class="hero-content">
            ...
            <div class="hero-hashtag">Scopri il nostro menù: un mix di sapori autentici e ingredienti di prima scelta, pensato per soddisfare ogni palato!</div>
        </div>
    </section>
    ...
    <section class="home-section">
        <div class="container" style="margin:0 auto;">
            <a href="img/menu.png" target="_blank">
                <img 
                    src="img/menu.png" 
                    alt="Menu DONER KEBAB 21" 
